...
### Ph.D. Students
* **Jiahao Xu (with Prof. Bin Fan)**(2026–present) – USTB. Research focus: Multi-modality unstructured off-road 3D occupancy.
* **Qingyang Mu (with Prof. Bin Fan)**(2026–present) – USTB. Research focus: Multi-modality unstructured off-road semantic segmentation, Domain Adaptation/Generalization.
...
* **Ganhong Wang (with Prof. Bin Fan)**(2026–present) – USTB. Research focus: mllm in vision downstream tasks, underwater vision perception.
